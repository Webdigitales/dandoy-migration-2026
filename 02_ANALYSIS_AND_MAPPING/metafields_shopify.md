...
## Choix prédéfinis (Validation)

Après l'import Matrixify, configurer les choix prédéfinis pour chaque metafield dans
**Settings → Custom data → Products → (cliquer sur la définition) → Validation → Predefined choices**.

Cela transforme le champ libre en **dropdown** dans l'admin produit et évite les erreurs
de saisie lors de l'ajout de nouveaux produits.
...
| Metafield | Raison |
|---|---|
| `custom.technology` | 77 valeurs par marque — affichage fiche produit uniquement, pas de filtrage |
