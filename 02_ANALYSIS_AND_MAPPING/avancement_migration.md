...
│   ├── SCRIPTS/
│   │   ├── magento_to_shopify.py                ← script principal
│   │   └── generate_redirects.py                ← script redirections
...
|---|---|---|
| `shopify_products.csv` | 25 514 | 4 834 produits EN + 19 metafields |
...
| `shopify_products_sample.csv` | 60 | Échantillon 10 produits (tous types) |
...
- Vérification HTTP : seuls les produits actifs et visibles ont une URL live
...
| Collections Shopify (mapping catégories Magento) | Moyenne | Non commencé |
